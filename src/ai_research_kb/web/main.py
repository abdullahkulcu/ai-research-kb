...
from .routers import auth, comments, consistency, docs, search, tasks
...
for router in (auth.router, search.router, docs.router, comments.router, consistency.router, tasks.router):
